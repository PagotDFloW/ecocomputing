...
class ResetPasswordController extends AbstractController
{
    ...
    public function reset(Request $request, UserPasswordHasherInterface $userPasswordHasher, string $token = null): Response
    {
        ...
        try {
            ...
            $this->addFlash('reset_password_error', sprintf(
                'Nous sommes navrés, il y a eu un problème avec votre demande de rénitialisation - %s',
                $e->getReason()
            ));
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer): RedirectResponse
    {
        ...
        if (!$user) {
            $this->addFlash('error', "Adresse email non reconnue, veuillez réessayer avec une autre adresse email.");
            return $this->redirectToRoute('app_forgot_password_request');
        }
